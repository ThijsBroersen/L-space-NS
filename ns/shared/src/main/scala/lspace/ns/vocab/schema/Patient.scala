...
object Patient
  ...
  override lazy val properties: List[LProperty] = List(diagnosis)
  trait Properties
      extends lspace.ns.vocab.schema.Person.Properties
      with lspace.ns.vocab.schema.MedicalAudience.Properties {
    lazy val diagnosis = lspace.ns.vocab.schema.diagnosis.property
  }
}
