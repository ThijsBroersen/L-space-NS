...
override lazy val properties: List[LProperty] = List(paymentDueDate, orderedItem, discount, discountCurrency, broker, discountCode, isGift, seller, paymentMethod, acceptedOffer, paymentMethodId, orderDelivery, merchant)
