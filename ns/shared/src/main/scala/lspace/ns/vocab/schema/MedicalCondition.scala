...
override lazy val properties: List[LProperty] = List(subtype, typicalTest, expectedPrognosis, signOrSymptom, possibleTreatment, associatedAnatomy, differentialDiagnosis, status, pathophysiology, secondaryPrevention, primaryPrevention, cause, possibleComplication, epidemiology, naturalProgression, riskFactor, stage)
