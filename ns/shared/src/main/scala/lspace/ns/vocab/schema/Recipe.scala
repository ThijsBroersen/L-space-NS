...
override lazy val properties: List[LProperty] = List(recipeIngredient, suitableForDiet, recipeCategory, cookingMethod, cookTime, ingredients, recipeCuisine, nutrition, recipeYield, recipeInstructions)
