...
override lazy val properties: List[LProperty] = List(departureGate, arrivalTerminal, boardingPolicy, webCheckinTime, flightNumber, flightDistance, mealService, seller, aircraft, estimatedFlightDuration, departureTerminal)
