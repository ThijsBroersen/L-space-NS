...
override lazy val properties: List[LProperty] = List(sourceOrganization, thumbnailUrl, inLanguage, comment, contentLocation, editor, publishingPrinciples, isPartOf, position, workTranslation, encodingFormat, aggregateRating, accessibilityControl, schemaVersion, educationalUse, isFamilyFriendly, temporalCoverage, genre, encodings, accessibilityAPI, expires, typicalAgeRange, fileFormat, citation, sdLicense, offers, accessibilityHazard, publisherImprint, character, locationCreated, accessibilitySummary, copyrightYear, exampleOfWork, discussionUrl, keywords, license, associatedMedia, mentions, version, provider, translator, sdDatePublished, workExample, creator, awards, commentCount, award, author, interactivityType, material, mainEntity, video, recordedAt, sdPublisher, accountablePerson, reviews, dateCreated, isBasedOn, audience, dateModified, producer, text, spatial, headline, translationOfWork, releasedEvent, hasPart, accessModeSufficient, contentReferenceTime, contentRating, publisher, review, isBasedOnUrl, materialExtent, learningResourceType, correction, spatialCoverage, audio, contributor, copyrightHolder, datePublished, accessMode, isAccessibleForFree, funder, interactionStatistic, encoding, sponsor, timeRequired, publication, accessibilityFeature, temporal, alternativeHeadline)
