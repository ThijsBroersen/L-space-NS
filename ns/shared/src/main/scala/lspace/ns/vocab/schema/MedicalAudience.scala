...
object MedicalAudience
  ...
  object keys
      extends lspace.ns.vocab.schema.MedicalEnumeration.Properties
      with lspace.ns.vocab.schema.Audience.Properties
      with lspace.ns.vocab.schema.PeopleAudience.Properties {}
