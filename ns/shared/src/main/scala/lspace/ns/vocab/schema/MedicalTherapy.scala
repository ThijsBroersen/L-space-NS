...
lazy val duplicateTherapy = lspace.ns.vocab.schema.duplicateTherapy.property
...
override lazy val properties: List[LProperty] = List(contraindication, duplicateTherapy, seriousAdverseOutcome)
