...
override lazy val properties: List[LProperty] = List(includedInHealthInsurancePlan, overdosage, dosageForm, alcoholWarning, nonProprietaryName, pregnancyWarning, administrationRoute, doseSchedule, labelDetails, foodWarning, clinicalPharmacology, isProprietary, clincalPharmacology, interactingDrug)
