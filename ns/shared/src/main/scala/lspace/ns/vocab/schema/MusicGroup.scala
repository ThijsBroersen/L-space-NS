...
object MusicGroup
  ...
  object keys extends lspace.ns.vocab.schema.PerformingGroup.Properties {
    ...
    lazy val tracks           = lspace.ns.vocab.schema.tracks.property
    lazy val musicGroupMember = lspace.ns.vocab.schema.musicGroupMember.property
  }
  override lazy val properties: List[LProperty] = List(genre, track, album, tracks, musicGroupMember)
