...
lazy val spouse = lspace.ns.vocab.schema.spouse.property
...
override lazy val properties: List[LProperty] = List(additionalName, address, affiliation, alumniOf, award, birthDate, birthPlace, brand, children, colleague, contactPoint, deathDate, deathPlace, duns, email, familyName, faxNumber, follows, funder, gender, givenName, globalLocationNumber, hasOccupation, hasOfferCatalog, hasPOS, height, homeLocation, honorificPrefix, honorificSuffix, isicV4, jobTitle, knows, knowsAbout, knowsLanguage, makesOffer, memberOf, naics, nationality, netWorth, owns, parent, performerIn, publishingPrinciples, relatedTo, seeks, sibling, sponsor, spouse, taxID, telephone, vatID, weight, workLocation, worksFor)
