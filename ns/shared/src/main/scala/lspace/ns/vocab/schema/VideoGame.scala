...
object VideoGame
  ...
  object keys
      extends lspace.ns.vocab.schema.Game.Properties
      with lspace.ns.vocab.schema.SoftwareApplication.Properties {
  ...
  override lazy val properties: List[Property] = List(gameTip, musicBy, directors, actors, playMode, director)
  trait Properties
      extends lspace.ns.vocab.schema.Game.Properties
      with lspace.ns.vocab.schema.SoftwareApplication.Properties {
    lazy val gameTip   = lspace.ns.vocab.schema.gameTip.property
