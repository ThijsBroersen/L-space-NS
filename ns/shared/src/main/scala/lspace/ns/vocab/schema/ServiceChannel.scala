...
override lazy val properties: List[LProperty] = List(processingTime, providesService, availableLanguage, serviceUrl, servicePostalAddress, serviceLocation, servicePhone, serviceSmsNumber)
