...
override lazy val properties: List[LProperty] = List(maps, geo, containedInPlace, geoTouches, hasMap, geoCovers, map, events, geoDisjoint, geoCoveredBy, additionalProperty, containedIn, publicAccess, slogan, containsPlace, photos, event, logo, telephone, isicV4, amenityFeature, geoEquals, branchCode, review, isAccessibleForFree, specialOpeningHoursSpecification, geoIntersects)
