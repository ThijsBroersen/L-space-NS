...
lazy val infectiousAgent = lspace.ns.vocab.schema.infectiousAgent.property
...
override lazy val properties: List[LProperty] = List(infectiousAgent, infectiousAgentClass, transmissionMethod)
