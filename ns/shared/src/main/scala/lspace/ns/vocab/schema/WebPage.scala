...
override lazy val properties: List[LProperty] = List(primaryImageOfPage, relatedLink, specialty, significantLinks, reviewedBy, mainContentOfPage, significantLink)
