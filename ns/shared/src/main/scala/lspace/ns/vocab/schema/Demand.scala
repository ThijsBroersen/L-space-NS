...
override lazy val properties: List[LProperty] = List(inventoryLevel, includesObject, areaServed, eligibleTransactionVolume, itemCondition, availabilityEnds, gtin14, eligibleDuration, availabilityStarts, sku, mpn, businessFunction, itemOffered, eligibleCustomerType, acceptedPaymentMethod, advanceBookingRequirement, seller, priceSpecification, availability, validThrough, serialNumber, validFrom, gtin12, gtin8, deliveryLeadTime, ineligibleRegion, warranty, eligibleRegion, eligibleQuantity, availableAtOrFrom, gtin13, availableDeliveryMethod)
