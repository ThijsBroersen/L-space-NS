...
override lazy val properties: List[LProperty] = List(screenCount)
trait Properties extends lspace.ns.vocab.schema.CivicStructure.Properties with lspace.ns.vocab.schema.EntertainmentBusiness.Properties{
lazy val screenCount = lspace.ns.vocab.schema.screenCount.property
override lazy val address = lspace.ns.vocab.schema.address.property
override lazy val aggregateRating = lspace.ns.vocab.schema.aggregateRating.property
override lazy val faxNumber = lspace.ns.vocab.schema.faxNumber.property
