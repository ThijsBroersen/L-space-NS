...
lazy val population = lspace.ns.vocab.schema.population.property
...
lazy val studySubject = lspace.ns.vocab.schema.studySubject.property
}
override lazy val properties: List[LProperty] = List(healthCondition, outcome, population, sponsor, status, studyLocation, studySubject)
