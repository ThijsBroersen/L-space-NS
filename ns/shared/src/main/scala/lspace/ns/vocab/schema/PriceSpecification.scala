...
override lazy val properties: List[LProperty] = List(eligibleTransactionVolume, price, maxPrice, priceCurrency, valueAddedTaxIncluded, validThrough, validFrom, minPrice, eligibleQuantity)
