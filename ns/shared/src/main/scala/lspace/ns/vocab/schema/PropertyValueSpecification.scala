...
override lazy val properties: List[LProperty] = List(valuePattern, valueMinLength, minValue, readonlyValue, valueName, maxValue, stepValue, multipleValues, valueMaxLength, defaultValue, valueRequired)
