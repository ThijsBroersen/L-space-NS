...
object valueReference extends PropertyDef(
        ...
        `@extends` = () => List(),
        `@range` = () => List(QuantitativeValue.ontology, StructuredValue.ontology, QualitativeValue.ontology, Enumeration.ontology, PropertyValue.ontology)
       ){
